    ...
    def validate_expiry(self):
        if self.expire_strategy == UserExpireStrategy.START_ON_FIRST_USE:
            if not self.usage_duration:
                raise ValueError("User expire_strategy cannot be start_on_first_use without a valid usage_duration.")
            ...
            if not self.expire_date:
                raise ValueError("User expire_strategy cannot be fixed_date without a valid expire date.")
