...
SQLALCHEMY_CONNECTION_POOL_SIZE = config("SQLALCHEMY_CONNECTION_POOL_SIZE", default=10, cast=int)
SQLALCHEMY_CONNECTION_MAX_OVERFLOW = config("SQLALCHEMY_CONNECTION_MAX_OVERFLOW", default=-1, cast=int)
...
SINGBOX_SUBSCRIPTION_TEMPLATE = config("SINGBOX_SUBSCRIPTION_TEMPLATE", default=None)
XRAY_SUBSCRIPTION_TEMPLATE = config("XRAY_SUBSCRIPTION_TEMPLATE", default=None)
CLASH_SUBSCRIPTION_TEMPLATE = config("CLASH_SUBSCRIPTION_TEMPLATE", default=None)
...
TASKS_RECORD_USER_USAGES_INTERVAL = config("TASKS_RECORD_USER_USAGES_INTERVAL", default=30, cast=int)
TASKS_REVIEW_USERS_INTERVAL = config("TASKS_REVIEW_USERS_INTERVAL", default=30, cast=int)
TASKS_EXPIRE_DAYS_REACHED_INTERVAL = config("TASKS_EXPIRE_DAYS_REACHED_INTERVAL", default=30, cast=int)
TASKS_RESET_USER_DATA_USAGE = config("TASKS_RESET_USER_DATA_USAGE", default=3600, cast=int)
